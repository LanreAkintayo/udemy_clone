...
export default function OrderMordal({
  course,
  onClose,
  onSubmit,
  isNewPurchase,
    ...
    if (isNewPurchase) {
      ...
      if (!hasAgreedTOS) {
        return _createFormState(
          true,
          "You need to agree with the terms of service"
        );
      }
      return _createFormState();
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <label className="flex items-center mr-2">
                        <input
                          ...
                          onChange={(event) => {
                            ...
                            setOrder((prevOrder) => ({
                              ...prevOrder,
                              price: checked ? prevOrder.price : eth.perItem,
                            }));
                ...
                {formState.message && (
                  <div className="p-2 my-2 bg-yellow-300 text-yellow-700 rounded-lg text-sm">
                    {formState.message}
                  </div>
                )}
              </div>
